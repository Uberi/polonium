...
echo -e "#!/usr/bin/env bash\n/usr/share/polonium/polonium" > "$base_path/usr/bin/polonium"
...
cp ./resources/icon.png "$base_path/usr/share/pixmaps/"
mkdir --parents "$base_path/usr/share/polonium" # set up program files
cp -r ./dist/linux64/* "$base_path/usr/share/polonium/"
dpkg --build "$base_path" "./dist/Polonium $DISPLAY_VERSION Linux 64-bit.deb"
